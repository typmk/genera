...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_12196 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_12196(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_12197 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_12197(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12198 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12198(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12199 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12199(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12201 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12201(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12202 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12202(reader);
}
});
...
var G__12216 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__12217 = s.append(c);
c = G__12216;
s = G__12217;
continue;
}

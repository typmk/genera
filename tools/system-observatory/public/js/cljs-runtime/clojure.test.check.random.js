...
var clojure$test$check$random$IRandom$rand_long$dyn_18730 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_18730(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_18733 = (function (rng){
var x__5350__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_18733(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_18734 = (function (rng){
var x__5350__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_18734(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_18738 = (function (rng,n){
var x__5350__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_18738(rng,n);
}
});
...
var G__18711 = z;
if(((24) > (function (){var G__18712 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__18712) : clojure.test.check.random.longs.bit_count.call(null,G__18712));
})())){
return clojure.test.check.random.longs.bit_xor(G__18711,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__18711;
}
});
...
var G__18741 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__18742 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__18741;
ret = G__18742;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__18721){
var map__18722 = p__18721;
var map__18722__$1 = cljs.core.__destructure_map(map__18722);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18722__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__18723 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18723,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18723,(1),null);

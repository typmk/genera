...
return cljs.core.cons(cljs.core.first(s),(function (){var G__18766 = (n - (1));
var G__18767 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__18766,G__18767) : clojure.test.check.rose_tree.exclude_nth.call(null,G__18766,G__18767));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__18775 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__18775) : f.call(null,G__18775));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__18774_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__18774_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__18774_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__18776_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__18776_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__18776_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__18777_SHARP_){
var G__18778 = clojure.test.check.rose_tree.root(p1__18777_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__18778) : pred.call(null,G__18778));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__5480__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__18779(s__18780){
return (new cljs.core.LazySeq(null,(function (){
var s__18780__$1 = s__18780;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__18780__$1);
if(temp__5804__auto__){
var xs__6360__auto__ = temp__5804__auto__;
var vec__18788 = cljs.core.first(xs__6360__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18788,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18788,(1),null);
var iterys__5476__auto__ = ((function (s__18780__$1,vec__18788,rose,index,xs__6360__auto__,temp__5804__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__18779_$_iter__18781(s__18782){
return (new cljs.core.LazySeq(null,((function (s__18780__$1,vec__18788,rose,index,xs__6360__auto__,temp__5804__auto__){
return (function (){
var s__18782__$1 = s__18782;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__18782__$1);
if(temp__5804__auto____$1){
var s__18782__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__18782__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__18782__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__18784 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__18783 = (0);
while(true){
if((i__18783 < size__5479__auto__)){
var child = cljs.core._nth(c__5478__auto__,i__18783);
cljs.core.chunk_append(b__18784,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__18836 = (i__18783 + (1));
i__18783 = G__18836;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__18784),clojure$test$check$rose_tree$permutations_$_iter__18779_$_iter__18781(cljs.core.chunk_rest(s__18782__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__18784),null);
}
} else {
var child = cljs.core.first(s__18782__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__18779_$_iter__18781(cljs.core.rest(s__18782__$2)));
}
} else {
return null;
}
...
});})(s__18780__$1,vec__18788,rose,index,xs__6360__auto__,temp__5804__auto__))
,null,null));
});})(s__18780__$1,vec__18788,rose,index,xs__6360__auto__,temp__5804__auto__))
;
var fs__5477__auto__ = cljs.core.seq(iterys__5476__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__5477__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5477__auto__,clojure$test$check$rose_tree$permutations_$_iter__18779(cljs.core.rest(s__18780__$1)));
} else {
var G__18837 = cljs.core.rest(s__18780__$1);
s__18780__$1 = G__18837;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__18796_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__18796_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__18796_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__18797_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__18797_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__18797_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__18802 = f;
var G__18803 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__18802,G__18803) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__18802,G__18803));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__18818 = f;
var G__18819 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__18818,G__18819) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__18818,G__18819));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {

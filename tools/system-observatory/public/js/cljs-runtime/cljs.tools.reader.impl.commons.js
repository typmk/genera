...
var G__12267 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__12267;
continue;
} else {
return ch;
...
var vec__12262 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12262,(0),null);
return (match === s);
});
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq12265){
var G__12266 = cljs.core.first(seq12265);
var seq12265__$1 = cljs.core.next(seq12265);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12266,seq12265__$1);
}));
...
while (G__12287__i < G__12287__a.length) {G__12287__a[G__12287__i] = arguments[G__12287__i + 1]; ++G__12287__i;}
  _ = new cljs.core.IndexedSeq(G__12287__a,0,null);
} 

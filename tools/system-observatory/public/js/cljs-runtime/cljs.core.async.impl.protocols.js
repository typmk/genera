...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10628 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10628(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10630 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10630(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10632 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10632(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10633 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10633(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10634 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10634(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10635 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10635(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_10638 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_10638(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10645 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10645(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10646 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10646(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10647 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10647(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10648 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10648(b);
}
});

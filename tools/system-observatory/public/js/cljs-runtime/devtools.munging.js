...
var o10256 = temp__5802__auto__;
var temp__5802__auto____$1 = (o10256["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o10257 = temp__5802__auto____$1;
return (o10257["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__8341__auto__ = f;
return (o__8341__auto__["toString"]).call(o__8341__auto__);
} else {
return "";
}
}catch (e10258){var _ = e10258;
return "";
}});
...
try{var o__8341__auto___10410 = t;
(o__8341__auto___10410["cljs$lang$ctorPrWriter"]).call(o__8341__auto___10410,t,writer);
}catch (e10259){var __10411 = e10259;
}
...
var char_code = (function (){var o__8341__auto__ = (new String(char$));
return (o__8341__auto__["charCodeAt"]).call(o__8341__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__8341__auto__ = String;
return (o__8341__auto__["fromCharCode"]).call(o__8341__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__10263 = num_code;
switch (G__10263) {
case (1):
return (185);
...
var o__8341__auto__ = String;
return (o__8341__auto__["fromCharCode"]).call(o__8341__auto__,superscript_code);
});
/**
...
}catch (e10264){var _e__8373__auto__ = e10264;
return false;
}})())){
...
var vec__10265 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10265,(0),null);
...
var G__10427 = (i__5727__auto___10423 + (1));
i__5727__auto___10423 = G__10427;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__10273){
var vec__10274 = p__10273;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10274,(0),null);
...
var G__10428 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__10429 = cljs.core.butlast(remaining_tokens);
name_tokens = G__10428;
remaining_tokens = G__10429;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq10271){
var G__10272 = cljs.core.first(seq10271);
var seq10271__$1 = cljs.core.next(seq10271);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10272,seq10271__$1);
}));
...
var vec__10282 = cljs.core.split_with((function (p1__10278_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__10278_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10282,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10282,(1),null);
...
var vec__10288 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10288,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10288,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__10431 = cljs.core.rest(remaining_tokens);
var G__10432 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__10431;
name_tokens = G__10432;
continue;
} else {
...
var vec__10306 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10306,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10306,(1),null);
var vec__10309 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10309,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10309,(1),null);
var vec__10312 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10312,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10312,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10312,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10312,(3),null);
...
var vec__10326 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10326,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10326,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10326,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10326,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10326,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10326,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__10329 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10329,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10329,(1),null);
var vec__10332 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10332,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10332,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__10335 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__10335) : devtools.munging.parse_fn_info_deep.call(null,G__10335));
})()));
}
} else {
return fn_info;
...
var G__10447 = (arity + (1));
var G__10448 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__10339){
var vec__10340 = p__10339;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10340,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10340,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10343_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__10343_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10344_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__10344_SHARP_);
}),sorted_infos);
...
var args__5732__auto__ = [];
var len__5726__auto___10455 = arguments.length;
var i__5727__auto___10456 = (0);
while(true){
if((i__5727__auto___10456 < len__5726__auto___10455)){
args__5732__auto__.push((arguments[i__5727__auto___10456]));

var G__10457 = (i__5727__auto___10456 + (1));
i__5727__auto___10456 = G__10457;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__10350){
var vec__10351 = p__10350;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10351,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq10348){
var G__10349 = cljs.core.first(seq10348);
var seq10348__$1 = cljs.core.next(seq10348);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10349,seq10348__$1);
}));
...
var G__10357 = arg;
var G__10357__$1 = (((G__10357 instanceof cljs.core.Keyword))?G__10357.fqn:null);
switch (G__10357__$1) {
...
var map__10358 = options;
var map__10358__$1 = cljs.core.__destructure_map(map__10358);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10358__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10358__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10358__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10358__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__10359 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10359,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10359,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10359,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10359,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10359,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10359,(5),null);
...
var o__8341__auto__ = f;
return (o__8341__auto__["getBasis"]).call(o__8341__auto__);
});
/**
...
}catch (e10374){var _e__8373__auto__ = e10374;
...
var G__10459 = (obj[cljs.core.first(path)]);
var G__10460 = cljs.core.rest(path);
obj = G__10459;
path = G__10460;
continue;
} else {
...
var _STAR_ = (function (accum,p__10385){
var vec__10386 = p__10385;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10386,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10386,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__10395){
var vec__10396 = p__10395;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10396,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10396,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10396,(2),null);
...
var post_process = (function (p__10400){
var vec__10401 = p__10400;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10401,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10401,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10399_SHARP_){
return (obj[cljs.core.first(p1__10399_SHARP_)]);
}),sorted_matches);

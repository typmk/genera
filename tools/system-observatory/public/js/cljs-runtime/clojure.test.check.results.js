...
var clojure$test$check$results$Result$pass_QMARK_$dyn_19909 = (function (result){
...
return clojure$test$check$results$Result$pass_QMARK_$dyn_19909(result);
}
});

var clojure$test$check$results$Result$result_data$dyn_19911 = (function (result){
var x__5350__auto__ = (((result == null))?null:result);
...
return clojure$test$check$results$Result$result_data$dyn_19911(result);
}
});

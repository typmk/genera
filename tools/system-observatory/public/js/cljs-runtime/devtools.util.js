...
args__5732__auto__.push((arguments[i__5727__auto___10893]));
...
var _STAR_print_newline_STAR__orig_val__10835_10900 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__10836_10901 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__10837_10902 = true;
var _STAR_print_fn_STAR__temp_val__10838_10903 = (function (x__5648__auto__){
return sb__5647__auto__.append(x__5648__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__10837_10902);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__10838_10903);

try{var _STAR_print_level_STAR__orig_val__10844_10905 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__10845_10906 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__10845_10906);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__10844_10905);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__10836_10901);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__10835_10900);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq10825){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq10825));
}));
...
var new_formatters = current_formatters.filter((function (p1__10857_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__10857_SHARP_)));
}));
...
var G__10859_10927 = f;
var target__8367__auto___10928 = G__10859_10927;
if(cljs.core.truth_(target__8367__auto___10928)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10859_10927)].join(''),"\n","target__8367__auto__"].join('')));
}

(target__8367__auto___10928["toString"] = (function (){
...
var G__10861_10929 = "%c%s";
var G__10862_10930 = "color:transparent";
var G__10863_10931 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__10861_10929,G__10862_10930,G__10863_10931) : f.call(null,G__10861_10929,G__10862_10930,G__10863_10931));
...
args__5732__auto__.push((arguments[i__5727__auto___10938]));
...
var vec__10869 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10869,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10869,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__10940__delegate = function (add_fmt,add_args){
...
var G__10940 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__10941__i = 0, G__10941__a = new Array(arguments.length -  1);
while (G__10941__i < G__10941__a.length) {G__10941__a[G__10941__i] = arguments[G__10941__i + 1]; ++G__10941__i;}
  add_args = new cljs.core.IndexedSeq(G__10941__a,0,null);
} 
return G__10940__delegate.call(this,add_fmt,add_args);};
G__10940.cljs$lang$maxFixedArity = 1;
G__10940.cljs$lang$applyTo = (function (arglist__10942){
var add_fmt = cljs.core.first(arglist__10942);
var add_args = cljs.core.rest(arglist__10942);
return G__10940__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq10864){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10865,G__10866,G__10867,seq10864__$3);
}));
...
var seq__10876 = cljs.core.seq(features);
var chunk__10877 = null;
var count__10878 = (0);
var i__10879 = (0);
while(true){
if((i__10879 < count__10878)){
var feature = chunk__10877.cljs$core$IIndexed$_nth$arity$2(null,i__10879);
...
var G__10944 = seq__10876;
var G__10945 = chunk__10877;
var G__10946 = count__10878;
var G__10947 = (i__10879 + (1));
seq__10876 = G__10944;
chunk__10877 = G__10945;
count__10878 = G__10946;
i__10879 = G__10947;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__10876);
if(temp__5804__auto__){
var seq__10876__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__10876__$1)){
var c__5525__auto__ = cljs.core.chunk_first(seq__10876__$1);
var G__10948 = cljs.core.chunk_rest(seq__10876__$1);
var G__10949 = c__5525__auto__;
var G__10950 = cljs.core.count(c__5525__auto__);
var G__10951 = (0);
seq__10876 = G__10948;
chunk__10877 = G__10949;
count__10878 = G__10950;
i__10879 = G__10951;
continue;
} else {
var feature = cljs.core.first(seq__10876__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__10952 = cljs.core.next(seq__10876__$1);
var G__10953 = null;
var G__10954 = (0);
var G__10955 = (0);
seq__10876 = G__10952;
chunk__10877 = G__10953;
count__10878 = G__10954;
i__10879 = G__10955;
continue;
}
} else {
...
var G__10882 = feature;
var G__10882__$1 = (((G__10882 instanceof cljs.core.Keyword))?G__10882.fqn:null);
switch (G__10882__$1) {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o10884 = temp__5802__auto__;
return (o10884["version"]);
} else {
return null;
}
})() == null);

...
}catch (e11733){var _e__8373__auto__ = e11733;
return false;
...
}catch (e11735){var _e__8373__auto__ = e11735;
return false;
...
}catch (e11737){var _e__8373__auto__ = e11737;
return false;
...
}catch (e11739){var _e__8373__auto__ = e11739;
return false;
...
}catch (e11741){var _e__8373__auto__ = e11741;
return false;
}})())){
...
}catch (e11743){var _e__8373__auto__ = e11743;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__11745 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__11746 = (function (){var or__5002__auto__ = config;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__11746);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__11745);
}});
});

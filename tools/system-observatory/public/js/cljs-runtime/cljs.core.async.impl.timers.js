...
var i_11420 = (self__.level + (1));
while(true){
if((i_11420 <= (new_level + (1)))){
(update[i_11420] = self__.header);

var G__11421 = (i_11420 + (1));
i_11420 = G__11421;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_11422 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_11422[i]));
} else {
x__$2.forward.push((((i < links_11422.length))?(links_11422[i]):null));
}

if((i < links_11422.length)){
(links_11422[i] = x__$2);
} else {
links_11422.push(x__$2);
}
...
var i_11424 = (0);
while(true){
if((i_11424 <= self__.level)){
var links_11425 = (update[i_11424]).forward;
if((x__$1 === (((i_11424 < links_11425.length))?(links_11425[i_11424]):null))){
(links_11425[i_11424] = (x__$1.forward[i_11424]));

var G__11426 = (i_11424 + (1));
i_11424 = G__11426;
continue;
} else {
var G__11427 = (i_11424 + (1));
i_11424 = G__11427;
continue;
}
} else {
...
var G__11429 = nx;
var G__11430 = (level__$1 - (1));
x = G__11429;
level__$1 = G__11430;
continue;
} else {
var G__11431 = x;
var G__11432 = (level__$1 - (1));
x = G__11431;
level__$1 = G__11432;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__11434 = nx;
var G__11435 = (level__$1 - (1));
x = G__11434;
level__$1 = G__11435;
continue;
} else {
var G__11436 = x;
var G__11437 = (level__$1 - (1));
x = G__11436;
level__$1 = G__11437;
continue;
}

/**
 * emit_c.c — Layer 2a: C Source Emitter
 *
 * Compiles Clojure forms to C source code. Output IS C, so any C function
 * is callable directly — the parser IS the FFI.
 * Depends on: base.c, read.c
 */
#ifndef EMIT_C_INCLUDED
#define EMIT_C_INCLUDED
